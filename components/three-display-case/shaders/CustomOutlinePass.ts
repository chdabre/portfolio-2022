...
import {MeshNormalMaterial, PerspectiveCamera, Scene, ShaderMaterial, Vector2, WebGLRenderTarget} from "three";

class CustomOutlinePass extends Pass {
    private readonly renderScene: Scene;
    private readonly renderCamera: PerspectiveCamera;
    private readonly normalTarget: WebGLRenderTarget;
    private readonly normalOverrideMaterial: MeshNormalMaterial;
    ...
    render(renderer: THREE.WebGLRenderer, writeBuffer: WebGLRenderTarget, readBuffer: WebGLRenderTarget) {
    ...
    createOutlinePostProcessMaterial() {
        return new THREE.ShaderMaterial({
            uniforms: {
                ...
                outlineColor: { value: new THREE.Color(0x111111) },
